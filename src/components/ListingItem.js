  ...
  return (
    <li className="relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]">
      ...
      {onEdit && (
        <MdEdit
          title="Edit"
          className="absolute top-2 right-7 h-6 w-6 cursor-pointer bg-[#3377cc] rounded-full shadow-lg px-1 py-1 flex justify-center items-center"
      ...
      {onDelete && (
        <FaTrash
          title="Delete"
          className="absolute top-3 right-2 h-[14px] cursor-pointer text-red-500"
